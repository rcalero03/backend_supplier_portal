...
namespace ServiceLayer.Service
{
    public class AuthService : IAuthService
    {
        ...
        public JwtClaims DecodeJwtTokenAzure(string token)
        {
            try
            {
                ...
                if (jwtToken != null)
                {
                    if (jwtToken.Claims != null)
                    {
                        ...
                        var userIdClaim = jwtToken.Claims.FirstOrDefault(x => x.Type == "b9281388-e91e-49d6-a9fe-556e0dbeafd8");
        ...
        public JwtAuth createToken(Usuario user)
        {
            try
            {
